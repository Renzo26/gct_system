...
class Message(Base):
    ...
    # Uma mensagem trocada entre duas sessoes do sistema chega pelas duas
    # pontas com o mesmo id do WAHA; ela e duplicada so dentro da mesma conversa.
    __table_args__ = (
        UniqueConstraint(
            "conversation_id", "waha_message_id", name="uq_messages_conversation_waha_id"
        ),
    )
